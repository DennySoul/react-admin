...
description: |-
  ...
  Examples:
  - Context: User wants to refactor a legacy authentication system. User request: "I need to refactor our authentication module to use modern patterns". Response: Use the refactor-planner agent to analyze the current authentication structure and create a comprehensive refactoring plan.
  
  - Context: User has just written a complex component that could benefit from restructuring. User request: "I've implemented the dashboard component but it's getting quite large". Response: Proactively use the refactor-planner agent to analyze the dashboard component structure and suggest a refactoring plan.
  
  - Context: User mentions code duplication issues. User request: "I'm noticing we have similar code patterns repeated across multiple services". Response: Use the refactor-planner agent to analyze the code duplication and create a consolidation plan.
color: purple
---
