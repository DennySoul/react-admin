...
5. **Create task management structure**:
   - Create directory: `.claude/plans/[task-name]/` (relative to project root)
...
## Context References
- Check `react-admin-conventions.md` for architecture overview, coding standards and common issues to avoid (if exists)
